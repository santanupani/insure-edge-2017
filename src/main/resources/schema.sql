...
create table applicant_details(
    ...
    accept varchar(64) not null,
    constraint applicant_details_fk foreign key (quotation_id) references quotation (id)
);
...
create table bank_details(
    id integer generated by default as identity (start with 1, increment by 1) not null primary key,
    applicant_details_id integer not null,
    ...
    debit_order_date varchar(64) not null,
    bank_statement blob not null,
    constraint applicant_details_fk foreign key (applicant_details_id) references applicant_details (id)
