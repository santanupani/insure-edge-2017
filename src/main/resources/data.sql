...
/*Product2*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '13', 'What do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '14', 'What is the maximum amount you wish to insure ?', 				    2, 	null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '15', 'Is the above amount the total full value of the goods being stored ?',  4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '16', 'What is the total full value of the goods being stored ?',             2,  3,  'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '17', 'Please give a full description of the goods to be insured ?',          2,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '18', 'Please provide details of vault:(If applicable) ?',                                      4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '19', 'Is the goods goin to be stored in vault ?',                                       4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '20', 'Is vault is secured with re-enforced concrete on all sides as well as top and bottm ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '21', 'Is vault have seismic detectors fitted inside the vault ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '22', 'Is vault have 24 hour inferred cameras and normal CCTV 24 hours recording ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '23', 'Is vault have an alarm and is it linked to an external response company ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '24', 'What is the type of storage of vault ?',                 5,  7,    'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '25', 'What is the address of the stored vault ?',                 5,  7,    'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '26', 'What is the SABS safety category of the vault, if any ?',              3,  null,   null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '27', 'If secured by any other means not noted, please provide details in the adjacent fields ?',                 5,  null,    null);
...
/*Product3*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '29', 'What do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '30', 'What is the maximum amount you wish to insure ?',                      2, 	null, 	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '31', 'Is the above amount the total full value of the goods being moved ?',  4,	null, 	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '32', 'What is the total full value of the goods being moved ?',              2,   3, 		'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '33', 'For additional premium, do you want first loss cover ?',               4,   null,	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '34', 'Do you use the service of a professional valuables carriers ?',        4,   null,	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '35', 'What is the name of the professional valuables carriers ?',            3,   6,	  	'true');
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '36', 'By whom and how are the valuables carried ?',                           5,	6, 		'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '37', 'How many times per week are the valuables carried ?',                   3,  null,  	null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '38', 'From where and to where are the valuables carried.',                    3,    null,  null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '39', 'What is the approximate distance ?'                 ,                    3,    null,  null);
...
/*product4*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '41', 'What do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '42', 'What is the maximum amount you wish to insure in Cash in transit ?',                      2, 	null, 	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '43', 'Is the above amount the total full value of the goods being moved in  Cash in transit ?',  4,	null, 	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '44', 'What is the total full value of the goods being moved in Cash in transit ?',              2,   3, 		'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '45', 'For additional premium, do you want first loss cover ?',               4,   null,	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '46', 'Do you use the service of a professional valuables carriers ?',        4,   null,	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '47', 'What is the name of the professional valuables carriers ?',            3,   6,	  	'true');
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '48', 'By whom and how are the valuables carried ?',                           5,	6, 		'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '49', 'How many times per week are the valuables carried ?',                   3,  null,  	null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '50', 'From where and to where are the valuables carried.',                    3,    null,  null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '51', 'What is the approximate distance ?'                 ,                    3,    null,  null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '52', 'What is the maximum amount you wish to insure in Static ?', 				    2, 	null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '53', 'Is the above amount the total full value of the goods being stored in Static ?',  4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '54', 'What is the Total Full Value of the goods being stored in Static ?',             2,  13,  'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '55', 'Please give a full description of the goods to be insured ?',          2,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '56', 'Please provide details of vault:(If applicable) ?',                                      4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '57', 'What is the SABS safety category of the vault, if any ?',              3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '58', 'Is the goods going to be stored in vault ?',                                       4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '59', 'Is the vault secured with re-enforced concrete on all sides as well as top and bottm ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '60', 'Is the vault having seismic detectors fitted inside the vault ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '61', 'Is the vault having 24 hour inferred cameras and normal CCTV 24 hours recording ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '62', 'Is the vault having an alarm and is it linked to an external response company ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '63', 'What is the type of storage of vault ?',                 5,  18,    'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '64', 'What is the address of the stored vault?',                 5,  18,    'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '65', 'If secured by any other means not noted, please provide details in the adjacent fields ?',                 5,  null,    null);
