...
/*Product1*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('1', '1', 'Do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('1', '11', 'What is the approximate distant ?'                 ,                    3,    null,  null);
...
/*Product2*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '13', 'Do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '14', 'Maximum amount you wish to insure ?', 				    2, 	null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '18', 'Details of Vault:(If applicable) ?',                                      4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '19', 'Will Goods be stored in Vault ?',                                       4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '20', 'Secured with re-enforced concrete on all sides as well as top and bottm ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '21', 'Have seismic detectors fitted inside the Vault ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '22', 'Have 24 hour inferred cameras and normal CCTV 24 hours recording ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '23', 'Have an alarm and is it linked to an external response company ?',                 4,  7,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '24', 'Type of Storage ?',                 5,  7,    'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('2', '25', 'Address ?',                 5,  7,    'false');
...
/*Product3*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '29', 'Do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('3', '39', 'What is the approximate distant ?'                 ,                    3,    null,  null);
...
/*product4*/
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '41', 'Do you wish to insure ?',                 3,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '42', 'What is the maximum amount you wish to insure ?',                      2, 	null, 	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '43', 'Is the above amount the total full value of the goods being moved ?',  4,	null, 	null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '44', 'What is the total full value of the goods being moved ?',              2,   3, 		'false');
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '51', 'What is the approximate distant ?'                 ,                    3,    null,  null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '52', 'Maximum amount you wish to insure ?', 				    2, 	null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '53', 'Is the above amount the Total Full Value of the goods being stored ?',  4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '54', 'What is the Total Full Value of the goods being stored ?',             2,  13,  'false');
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '56', 'Details of Vault:(If applicable) ?',                                      4,  null,    null);
...
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '58', 'Will Goods be stored in Vault ?',                                       4,  null,    null);
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '59', 'Secured with re-enforced concrete on all sides as well as top and bottm ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '60', 'Have seismic detectors fitted inside the Vault ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '61', 'Have 24 hour inferred cameras and normal CCTV 24 hours recording ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '62', 'Have an alarm and is it linked to an external response company ?',                 4,  18,    'true');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '63', 'Type of Storage ?',                 5,  18,    'false');
insert into questionnaires(product_id, sequence_number, question, answer_type_id, depends_on, on_answer)  values('4', '64', 'Address ?',                 5,  18,    'false');
