...
public class AttachmentService {
    ...
    public byte[] getInvestigationReport(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
    ...
    public byte[] getAffidavit(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getProofOfPickup(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getAmountBanked(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getTransTrackDocument(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getQuote(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getReport(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getPhoto1(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getPhoto2(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
    ...
    public byte[] getPhoto3(@PathVariable("claimNumber") String claimNumber) throws JRException, IOException {
        ClaimRequest claimRequest = claimRequestRepository.findByClaimNumber(claimNumber);
