...
public class ProductService {
    ...
    @RequestMapping(value = "api/products/{product_id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public List<ProductQuery> get(@PathVariable("product_id") Long product_id) {
        System.out.println("Product id is : " + product_id);        
        List<Product> products = productRepository.findByProductId(product_id);
        return ProductMapper.toQueryModel(products);
    }
