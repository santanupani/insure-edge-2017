...
public class Service {
	...
	@RequestMapping(value = "api/view-quotation/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public QuotationQueryModel viewQuotation(@PathVariable("id") Long id) {
